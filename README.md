...
References for this literature can be found [here](https://docs.google.com/spreadsheets/d/18pdnRo4YRhHoqYscke5tRJ5VKvsj5YjO/edit?usp=sharing&ouid=113780279741164989313&rtpof=true&sd=true). Descriptions of the variables (both descriptive information about the values and the nutrient values themselves) as well as the unit reported per 100 grams is available [here](https://docs.google.com/spreadsheets/d/1edCEIJftNJQc3TG5z4nDaho6_T638BlS/edit?usp=sharing&ouid=113780279741164989313&rtpof=true&sd=true).
